...
const Register = () => {
    ...
    useEffect( ()=> {
        setValidSchoolName(SCHOOL_REGEX.test(school));
    }, [school]);
    ...
    useEffect(() => {
        setValidName(USER_REGEX.test(first));
    }, [first])
                ...
                <section>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <label htmlFor="schoolname">
                            School Name:
                            <FontAwesomeIcon icon={faCheck} className={validSchoolName ? "valid" : "hide"} />
                            <FontAwesomeIcon icon={faTimes} className={validSchoolName || !school ? "hide" : "invalid"} />
                        </label>
                        ...
                        <input
                            ...
                            value={school}
                            required
                            aria-invalid={validSchoolName ? "false" : "true"}
                            aria-describedby="schoolnote"
                            onFocus={() => setSchoolFocus(true)}
                            onBlur={() => setSchoolFocus(false)}
                        />

                        <p id="schoolnote" className={schoolFocus && school && !validSchoolName ? "instructions" : "offscreen"}>
                        ...
                        <label htmlFor="username">
                            ...
                            <FontAwesomeIcon icon={faTimes} className={validName || !first ? "hide" : "invalid"} />
                        </label>
                        <input
                            type="text"
                            id="username"
                        ...
                        />
                        <p id="uidnote" className={userFocus && first && !validName ? "instructions" : "offscreen"}>
                            <FontAwesomeIcon icon={faInfoCircle} />
                            4 to 24 characters.<br />
                            Must begin with a letter.<br />
                            Letters, numbers, underscores, hyphens allowed.
                        ...
                        <button disabled={!validLast || !validSchoolName || !validEmail || !validName || !validPwd || !validMatch ? true : false}>Sign Up</button>
                    </form>
                    <p>
